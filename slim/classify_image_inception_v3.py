...
#这是将tensorflow的命令行模式直接转为py文件的格式进行操作，不会调用不同的线程运行不同的程序
# def run_inference_on_image_copy(model_path1,label_path1,image_file1,image,num_top_predictions1):
#     global model_path
#     global label_path
#     global image_file
...
#     num_top_predictions=num_top_predictions1
